{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 50.0, 44.0, 1093.0, 687.0 ],
		"bglocked" : 0,
		"defrect" : [ 50.0, 44.0, 1093.0, 687.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 640.0, 69.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 31.0, 149.0, 62.0, 19.0 ],
									"text" : "t b b clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 32.0, 107.0, 128.0, 31.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 52.0, 207.0, 425.0, 20.0 ],
													"text" : "jcom.ambimonitor2position @prefix jmod.sur.vimic~/microphones @radius 10."
												}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 145.0, 121.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 319.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 599.0, 222.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
					"varname" : "/reverb~"
				}
...
,
					"patching_rect" : [ 784.0, 293.0, 44.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 897.0, 176.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 880.0, 196.0, 36.0, 17.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 787.0, 64.0, 300.0, 105.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 889.5, 303.0, 676.5, 303.0 ],
					"source" : [ "obj-190", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-176", 1 ],
					"hidden" : 0,
					"midpoints" : [ 676.5, 196.0, 587.0, 196.0, 587.0, 303.0, 676.5, 303.0 ],
					"source" : [ "obj-201", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 676.5, 196.5, 749.0, 196.5 ],
					"source" : [ "obj-201", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 889.5, 217.0, 889.5, 217.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-201", 1 ],
					"hidden" : 0,
					"midpoints" : [ 890.166687, 175.0, 783.0, 175.0, 783.0, 63.0, 676.5, 63.0 ],
					"source" : [ "obj-35", 1 ]
				}
