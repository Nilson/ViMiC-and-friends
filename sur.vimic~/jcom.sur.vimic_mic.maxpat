...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 172.0, 1303.0, 471.0, 17.0 ],
									"text" : "append @type string @repetitions/allow 1 @description \\\"load a directivity preset for the Nth microphone\\\" @priority"
								}
