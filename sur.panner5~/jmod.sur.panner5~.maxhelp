{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 240.0, 44.0, 775.0, 690.0 ],
		"bglocked" : 0,
		"defrect" : [ 240.0, 44.0, 775.0, 690.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.0, 219.0, 150.0, 48.0 ],
					"text" : "todo: master gain only works when sources are being moved again :("
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 476.0, 295.0, 94.0, 20.0 ],
					"text" : "jcom.unpack≈ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 485.0, 235.0, 18.0 ]
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multicore.connect", "" ],
									"patching_rect" : [ 60.0, 108.0, 88.0, 20.0 ],
									"text" : "jcom.pack≈ 2"
								}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 560.5, 289.0, 485.5, 289.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"hidden" : 0,
					"midpoints" : [ 92.5, 455.5, 256.5, 455.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 485.5, 326.5, 355.5, 326.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 500.5, 334.5, 421.5, 334.5 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 515.5, 343.5, 493.5, 343.5 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 530.5, 327.5, 567.5, 327.5 ],
					"source" : [ "obj-8", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 545.5, 349.5, 272.5, 349.5 ],
					"source" : [ "obj-8", 4 ]
				}
