...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.666672, 131.0, 412.0, 53.0 ],
					"text" : "jmod.autotalent~ jmod.interpolate~ jmod.attributeUI jmod.quneo jmod.boids3d jmod.fffb~ jmod.scene3D jmod.sur.modulate~ jmod.sur.panner5~ jmod.sur.reverb~ jmod.sur.sourceControl jmod.sur.vimic~ jmod.sur.vimic8~ jmod.sur.vimic8poly~ jmod.gl.waterfall%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.5, 821.0, 235.0, 43.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 319.5, 572.5, 585.0, 572.5 ],
					"source" : [ "obj-138", 0 ]
				}
