	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 385.0, 54.0, 19.0 ],
					"text" : "zl slice 1"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 68.0, 232.0, 80.0, 20.0 ],
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 263.0, 141.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 207.0, 59.0, 20.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 68.0, 100.0, 141.0, 19.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 68.0, 186.0, 95.0, 19.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 68.0, 148.0, 93.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 68.0, 125.0, 46.0, 19.0 ],
									"text" : "atoi"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 68.0, 312.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 151.5, 176.0, 77.5, 176.0 ],
									"source" : [ "obj-56", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 2 ],
									"hidden" : 0,
									"midpoints" : [ 199.5, 126.5, 199.5, 126.5 ],
									"source" : [ "obj-62", 1 ]
								}
...
,
					"patching_rect" : [ 276.0, 309.0, 81.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 804.0, 414.0, 56.0, 19.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 803.0, 338.0, 54.0, 19.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 803.0, 386.0, 126.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 803.0, 363.0, 70.0, 19.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 769.0, 86.0, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 769.0, 460.0, 55.0, 19.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.0, 414.0, 106.0, 19.0 ],
					"text" : "s #1pgm_menu"
				}
...
,
					"patching_rect" : [ 669.0, 389.0, 126.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"globalpatchername" : "",
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 769.0, 489.0, 27.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.0, 217.0, 65.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 511.0, 350.0, 244.0, 19.0 ],
					"text" : "audiounit~ 2 2",
					"varname" : "au"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 88.166664, 468.0, 630.5, 468.0 ],
					"source" : [ "obj-12", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 117.5, 220.0, 785.5, 220.0 ],
					"source" : [ "obj-12", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 633.0, 378.0, 799.75, 378.0, 799.75, 332.0, 812.5, 332.0 ],
					"source" : [ "obj-23", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 128.5, 73.5, 778.5, 73.5 ],
					"source" : [ "obj-24", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 40.5, 73.5, 778.5, 73.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"hidden" : 0,
					"midpoints" : [ 285.5, 332.0, 367.0, 332.0, 367.0, 300.0, 467.5, 300.0 ],
					"source" : [ "obj-68", 0 ]
				}
