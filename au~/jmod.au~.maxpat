	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 525.0, 168.0, 17.0 ],
					"text" : "script delete parameterDummy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 450.0, 500.0, 54.0, 19.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message au/open @type string @description \"Open the plug-in's edit window. \\\"view\\\" or \\\"generic\\\" specifies what interface will be shown.\""
				}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 198.0, 27.0, 54.0, 19.0 ],
																	"text" : "zl slice 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 299.0, 78.0, 58.0, 19.0 ],
																	"text" : "zl change"
																}
...
, 											{
												"box" : 												{
													...
													"patcher" : 													{
														"fileversion" : 1,
														"rect" : [ 441.0, 309.0, 600.0, 426.0 ],
														"bglocked" : 0,
														"defrect" : [ 441.0, 309.0, 600.0, 426.0 ],
														"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
														"openinpresentation" : 0,
														"default_fontsize" : 10.0,
														"default_fontface" : 0,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 80.0, 127.0, 54.0, 19.0 ],
																	"text" : "zl slice 1"
																}
...
, 											{
												"box" : 												{
													...
													"patcher" : 													{
														"fileversion" : 1,
														"rect" : [ 56.0, 59.0, 1156.0, 553.0 ],
														"bglocked" : 0,
														"defrect" : [ 56.0, 59.0, 1156.0, 553.0 ],
														"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
														"openinpresentation" : 0,
														"default_fontsize" : 10.0,
														"default_fontface" : 0,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 829.0, 272.0, 197.0, 19.0 ],
																	"text" : "pack s s i i"
																}
...
, 															{
																"box" : 																{
																	...
																	"text" : "script newdefault $1 $3 $4 jcom.textslider @presentation_rect $3 $4 165 20 @text $2 @presentation 1 @range 0 1 @clickjump 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 475.0, 293.0, 328.0, 41.0 ],
																	"text" : "script newdefault $1 $2 $3 jcom.parameter $1 @type decimal @range/bounds 0. 1. @range/clipmode none @ramp/drive scheduler @priority 3 @description \"AU plugin parameter.\""
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 475.0, 268.0, 115.0, 19.0 ],
																	"text" : "pack s i i"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 167.0, 325.0, 212.0, 29.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 167.0, 301.0, 51.0, 19.0 ],
																	"text" : "pack s s"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 168.0, 273.0, 118.0, 19.0 ],
																	"text" : "tosymbol @separator"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 167.0, 251.0, 78.0, 17.0 ],
																	"text" : "textslider/ $1"
																}
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 177.5, 294.0, 161.0, 294.0, 161.0, 472.0, 823.0, 472.0, 823.0, 255.0, 838.5, 255.0 ],
																	"source" : [ "obj-18", 0 ]
																}
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 301.5, 298.0, 208.5, 298.0 ],
																	"source" : [ "obj-19", 0 ]
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-12", 0 ],
																	"hidden" : 0,
																	"midpoints" : [ 176.5, 376.5, 237.5, 376.5 ],
																	"source" : [ "obj-25", 0 ]
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-2", 2 ],
																	"hidden" : 0,
																	"midpoints" : [ 278.5, 137.5, 580.5, 137.5 ],
																	"source" : [ "obj-3", 1 ]
																}
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 278.5, 136.5, 1016.5, 136.5 ],
																	"source" : [ "obj-3", 1 ]
																}
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 221.5, 188.5, 957.166687, 188.5 ],
																	"source" : [ "obj-3", 0 ]
																}
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 174.5, 238.5, 897.833313, 238.5 ],
																	"source" : [ "obj-8", 0 ]
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-12", 0 ],
																	"hidden" : 0,
																	"midpoints" : [ 484.5, 377.5, 237.5, 377.5 ],
																	"source" : [ "obj-9", 0 ]
																}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 575.0, 600.0, 575.0, 31.0 ],
					"text" : "jcom.parameter parameter/pluginParameterName @type decimal @range/bounds 0. 1. @range/clipmode none @ramp/drive scheduler @priority 3 @description \"Address specific parameter of the AU plugin.\"",
					"varname" : "parameterDummy"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"hidden" : 0,
					"midpoints" : [ 211.5, 490.0, 414.5, 490.0 ],
					"source" : [ "obj-49", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"hidden" : 0,
					"midpoints" : [ 184.25, 497.0, 369.5, 497.0 ],
					"source" : [ "obj-49", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 157.0, 631.0, 182.5, 631.0 ],
					"source" : [ "obj-49", 2 ]
				}
