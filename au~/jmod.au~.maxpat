									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 73.0, 251.0, 55.0, 19.0 ],
													"text" : "qlim 500"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 73.0, 323.0, 56.0, 19.0 ],
													"text" : "change 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 506.0, 372.0, 142.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"patcher" : 													{
														"fileversion" : 1,
														"rect" : [ 73.0, 119.0, 1156.0, 553.0 ],
														"bglocked" : 0,
														"defrect" : [ 73.0, 119.0, 1156.0, 553.0 ],
														"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
														"openinpresentation" : 0,
														"default_fontsize" : 10.0,
														"default_fontface" : 0,
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 2,
																					"outlettype" : [ "", "" ],
																					"patching_rect" : [ 198.0, 46.0, 40.0, 20.0 ],
																					"text" : "zl reg"
																				}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "float" ],
																	"patching_rect" : [ 647.0, 105.0, 41.0, 19.0 ],
																	"text" : "abs 0."
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 647.0, 82.0, 117.0, 19.0 ],
...
, 															{
																"box" : 																{
																	...
																	"patcher" : 																	{
																		"fileversion" : 1,
																		"rect" : [ 358.0, 224.0, 754.0, 530.0 ],
																		"bglocked" : 0,
																		"defrect" : [ 358.0, 224.0, 754.0, 530.0 ],
																		"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
																		"openinpresentation" : 0,
																		"default_fontsize" : 12.0,
																		"default_fontface" : 0,
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 2,
																					"outlettype" : [ "", "" ],
																					"patching_rect" : [ 83.0, 78.0, 38.0, 19.0 ],
																					"text" : "zl reg"
																				}
...
, 															{
																"box" : 																{
																	...
																	"patching_rect" : [ 621.0, 45.0, 266.0, 19.0 ],
																	"text" : "unpack f f f s"
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-10", 0 ],
																	"hidden" : 0,
																	"midpoints" : [ 877.5, 226.0, 44.5, 226.0 ],
																	"source" : [ "obj-34", 3 ]
																}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 290.0, 70.0, 215.0, 20.0 ],
													"text" : "zl slice 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 290.0, 95.0, 70.0, 19.0 ],
													"text" : "fromsymbol"
												}
...
, 											{
												"patchline" : 												{
													...
													"hidden" : 0,
													"midpoints" : [ 299.5, 93.0, 398.5, 93.0 ],
													"source" : [ "obj-15", 0 ]
												}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 146.100006, 631.0, 182.5, 631.0 ],
					"source" : [ "obj-49", 2 ]
				}
