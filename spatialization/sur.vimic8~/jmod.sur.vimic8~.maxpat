...
,
					"patching_rect" : [ 327.0, 311.0, 162.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 269.0, 56.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.0, 247.0, 112.0, 20.0 ],
...
,
					"patching_rect" : [ 323.0, 788.0, 52.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 55.0, 754.0, 554.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 311.0, 80.0, 20.0 ],
					"text" : "r #0__setting"
				}
...
, 			{
				"box" : 				{
					"annotation" : "makes what solo should do",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 830.0, 172.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 819.0, 263.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 805.0, 355.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 810.0, 444.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 813.0, 539.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 803.0, 637.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 750.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 798.0, 79.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 204.0, 487.0, 190.0, 17.0 ],
					"text" : "jcom.unpack≈ 8"
				}
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 8",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-12",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 7",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-17",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 6",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-22",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 5",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-27",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 4",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-32",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 3",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-37",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 2",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-54",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					"annotation" : "opens the directiviy editor for source 1",
					"fontname" : "Verdana",
					"fontsize" : 9.0,
					"id" : "obj-58",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "front" ],
					"patching_rect" : [ 747.0, 78.0, 41.0, 20.0 ],
					"text" : "t front"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 34.504128, 1067.0, 55.0, 20.0 ],
									"text" : "jcom.init"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 675.0, 745.0, 267.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 649.0, 747.0, 20.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 574.406494, 650.578979, 19.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 823.0, 714.092285, 148.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 483.468628, 649.914612, 91.0, 19.0 ],
									"text" : "Minimize Delay:"
								}
...
,
									"patching_rect" : [ 343.0, 1097.0, 66.0, 20.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 360.0, 1076.0, 89.0, 31.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 20.0, 1.0, 92.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 343.0, 1077.0, 104.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 2.0, 104.0, 18.0 ],
									"size" : 1,
									"values" : [ 0 ]
								}
...
,
									"patching_rect" : [ 1.504128, 1042.47937, 38.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
,
									"patching_rect" : [ 45.504128, 1042.47937, 38.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 387.0, 582.0, 31.0, 19.0 ],
									"triangle" : 0,
									"varname" : "powerUnit"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 419.0, 582.0, 51.0, 20.0 ]
								}
...
,
									"patching_rect" : [ 265.0, 1093.0, 43.0, 20.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Verdana",
										"default_fontsize" : 10.0,
										"tags" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 1067.0, 80.0, 20.0 ],
									"text" : "r #0__setting"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 522.0, 675.0, 56.0, 19.0 ],
									"text" : "Reports:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 517.0, 693.0, 60.0, 19.0 ],
									"text" : "Warnings:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 580.0, 694.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 580.0, 675.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 468.363647, 877.818115, 94.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 417.790771, 657.0, 31.0, 19.0 ],
									"triangle" : 0
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 345.144897, 693.977844, 71.134186, 19.0 ],
									"text" : "Mic Polarity:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 330.468628, 675.914612, 86.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 329.775146, 658.287048, 87.0, 19.0 ],
									"text" : "Renderinterval:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 318.485718, 640.223816, 98.068405, 19.0 ],
									"text" : "Update rate [Hz]:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 347.838257, 622.160645, 69.0, 19.0 ],
									"text" : "Temp [ºC]:"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 417.790771, 620.825012, 35.0, 19.0 ],
									"triangle" : 0
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 418.406494, 693.707886, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 418.406494, 674.578979, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 240.363632, 941.818115, 94.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.504128, 1093.0, 210.0, 15.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.710693, 565.644592, 144.0, 15.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 142.0, 314.0, 15.0, 15.0 ]
												}
...
,
									"patching_rect" : [ 227.0, 972.0, 73.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
,
									"patching_rect" : [ 222.0, 1017.0, 49.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
,
									"patching_rect" : [ 291.0, 1011.0, 78.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
,
									"patching_rect" : [ 374.0, 1009.0, 75.0, 17.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Arial",
										"default_fontsize" : 12.0,
										"tags" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 377.958679, 985.214905, 50.0, 14.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.958679, 996.00824, 50.0, 14.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 6.826447, 1140.768677, 59.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 302.710693, 563.718994, 168.0, 57.0 ],
									"rounded" : 15
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 302.535706, 620.058533, 300.111847, 119.705276 ],
									"rounded" : 15
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 300.5, 1038.0, 181.371902, 1038.0 ],
									"source" : [ "obj-75", 0 ]
								}
...
, 							{
								...
								"bootpath" : "/Users/nilspeters/Documents/Max 6 Projects/ViMiC-5ch-standalone/data",
								"type" : "TEXT",
								"implicit" : 1
							}
, 							{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 238.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jalg.sur.vimic8~.maxpat #0_",
					"varname" : "jalg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 320.0, 22.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 319.5, 290.0, 19.5, 290.0 ],
					"source" : [ "obj-149", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 332.5, 817.0, 6.0, 817.0, 6.0, 267.0, 19.5, 267.0 ],
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/ViMiC/spatialization/sur.vimic8~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "VimicSurfaceProperties.txt",
				"bootpath" : "/Users/nilspeters/Documents/Max 6 Projects/ViMiC-5ch-standalone/data",
				"patcherrelativepath" : "../../../../../../Max 6 Projects/ViMiC-5ch-standalone/data",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
